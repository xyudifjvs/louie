...
struct FoodItemEditView: View {
    ...
    private func saveMeal() {
        // Pass updated food items back to parent view via callback
        onSave?(foodItems)
        
        /* // Remove all meal creation and saving logic from this view
        ...
        if var existingMeal = meal {
            ...
            // Make sure to preserve other relevant fields if needed
            ...
            let newMeal = MealEntry(
                ...
                micronutrients: MicroData(), // Assuming default is okay here
                userNotes: nil // Assuming no user notes from this view
            )
